...
export const inPerson_WhySelect = [
  {
    ...
    Reasons:[
      ...
      },
      {
        ...
        Description: "T-BASでは日本語も使って分からないことを分かるまで丁寧にレッスンします。また、学習のコツを指導するだけでなく、IB生に必要なタイムマネージメントの力もつけていきます。課題は時間をかけて質の高いものを作り上げるように意識を高めていきます。",
        ImageUrl: stats
      },
      {
        SubHeading: (<>
...
export const online_WhySelect = [
  {
    ...
    Reasons:[
      ...
      },
      {
        ...
        Description: "T-BASではIBを経験した講師が英語だけでなく日本語を交えて分からないことを分かるまで丁寧にレッスンします。また、IB生に必要なタイムマネージメントの力をつけていきます。課題は時間をかけて質の高いものを作り上げるように意識を高めていきます。",
        ImageUrl: stats
      },
      {
        SubHeading: (<>
